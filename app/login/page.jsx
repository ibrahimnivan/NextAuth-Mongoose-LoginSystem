...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Using the {signIn} function to attempt authentication.
    // signIn(provider: string, options?: object):
    // The {signIn} function returns a promise that resolves to an object (res)
